...
import screenshotPosts from '@/images/screenshots/dashboard-posts.png'
import screenshotProfile from '@/images/screenshots/dashboard-profile.png'
import screenshotSubmisstion from '@/images/screenshots/dashboard-submission.png'
...
const features: Array<Feature> = [
  ...
  },
  {
    ...
    summary:
      'You can edit your profile information, change your password, and upload your profile picture. etc.',
    description:
      'You can now view and edit your profile information directly in the frontend. Update your account, change your password, update your social media links, and more',
      ...
      <Container>
        <div className="mx-auto max-w-3xl md:text-center">
          <h2 className="font-display text-3xl tracking-tight text-slate-900 sm:text-4xl">
            Not need a WordPress admin page?
          </h2>
          <p className="mt-4 text-lg tracking-tight text-slate-700">
            Because now authors will be able to manage all their necessary
            information in the frontend. Manage articles, manage accounts,
