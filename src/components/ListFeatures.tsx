...
const featuresLists = [
  [
    {
      content:
        'Unlock new opportunities for WordPress. Your frontend is built entirely with Nextjs 13, offering great power, flexibility, and user interaction.',
      author: {
        name: 'Next.js 13 frontend',
