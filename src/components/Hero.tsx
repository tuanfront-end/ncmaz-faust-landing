  ...
  return (
    <Container className="pb-16 pt-20 text-center lg:pt-32">
      <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
        <span className="hidden sm:inline ">Ncmaz </span>
        Next.js{' '}
        <span className="relative text-blue-600 sm:whitespace-nowrap">
          ...
          <span className="relative">Headless WordPress</span>
        </span>{' '}
        for blog & magazine.
      </h1>
      <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
        Next.js Headless WordPress is a powerful solution that combines the
        flexibility of Next.js and the power of the WordPress content management
        system.
      </p>
      <div className="mt-10 flex justify-center gap-x-6">
        <Button target="_blank" href={BUY_LINK}>
          <span>
            Buy now
